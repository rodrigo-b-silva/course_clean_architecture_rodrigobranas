...
const DefaultFreigthCalculator_1 = __importDefault(require("../src/DefaultFreigthCalculator"));
const FixedFreigthCalculator_1 = __importDefault(require("../src/FixedFreigthCalculator"));
